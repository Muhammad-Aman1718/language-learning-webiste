...
const CourseCard = () => {
  return (
    <div className="border border-[#DFDFDF] max-w-[392px] mx-auto py-4 px-[18px] bg-white rounded-[8px] shadow-lg overflow-hidden hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1">
      ...
      <div className="mt-2">
        {/* Course Title */}
        <h3 className="text-[16px] font-semibold text-[#282828] mb-4 leading-tight">
        ...
        <div className="flex flex-wrap items-center gap-4 sm:gap-6 mb-6 text-gray-500">
          <div className="flex items-center space-x-2">
            ...
            <span className="text-[#080808] opacity-75 text-sm ">
              Lesson: 6
            </span>
          </div>
          <div className="flex items-center space-x-2">
          ...
          <div className="flex items-center space-x-2">
            ...
            <span className="text-[#080808] opacity-75 text-sm ">Advanced</span>
          </div>
        </div>
        ...
        <div className="mt-6 flex items-center justify-between">
          {/* Start Course Button */}
          <button className="bg-blue-600 hover:bg-blue-700 text-white font-semibold px-4 py-3 rounded-xl flex items-center justify-center gap-x-2 transition-all duration-300 transform hover:scale-105 shadow-md hover:shadow-lg">
